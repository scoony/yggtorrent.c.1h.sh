...
forum_login=`cat $HOME/.config/argos/.yggtorrent-account | awk '{print $3}'`
forum_password=`cat $HOME/.config/argos/.yggtorrent-account | awk '{print $4}'`
...
account_infos=`echo -e "yad --width=\"600\" --height=\"300\" --center --window-icon=\"$HOME/.config/argos/.cache-icons/yggtorrent-big.png\" --title=\"Authentification du compte\" --text=\"<big>\r\rVeuillez entrer vos informations didentification.\rCes informations ne transittent pas par internet.\r\r</big>\" --text-align=center --image=\"$HOME/.config/argos/.cache-icons/yggtorrent-big.png\" --form --separator=\" \" --field=\"Identifiant du site\" --field=\"Mot de passe du site\" --field=\"Identifiant du forum\" --field=\"Mot de passe du forum\" \"$ygg_login\" \"$ygg_password\" \"$forum_login\" \"$forum_password\" --button=gtk-ok:0 2>/dev/null >~/.config/argos/.yggtorrent-account"`
